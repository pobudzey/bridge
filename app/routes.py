...
from app.forms import LoginForm, SignupForm, PostForm, ProfileEditorForm, MessageForm, AddMemberForm, CreateGroupForm, ResetPasswordRequestForm, ResetPasswordForm
...
def reset_password_request():
    ...
    if form.validate_on_submit():
        ...
        flash('Check your email for the instructions to reset the password')
        return redirect(url_for('login'))
